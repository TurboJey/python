...
if interface != "none":
    ...
    while i < len(interface):
        subprocess.call("cat /dev/null > /home/kanakin/testbond/" + interface[0], shell=True)
        ...
        subprocess.call("echo 'NAME=slave'" + str(i) + ">> /home/kanakin/testbond/" + interface[i], shell=True)
